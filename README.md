This notebook demonstrates River and waterbodies Detection using Random Forest on raster data. It includes data preprocessing, model training, and result visualization.
